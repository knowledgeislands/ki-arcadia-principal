...
Decision Records live at `Admin/Governance/Decisions/`. The path `Admin/Decisions/` established in GDR-KI-ARCADIA-001 is updated; all tooling and references are moved to `Admin/Governance/Decisions/`.
