...
`Pillars/Knowledge Islands/Model/Tools/Claude/Live Artifacts/<Existing Artifact Name> Artifact.md` is the reference note with the canonical shape - follow its structure exactly.
...
After writing the recipe note, also write the current artifact HTML to `Pillars/Knowledge Islands/Model/Tools/Claude/Live Artifacts/<Artifact Name>.html` as the initial colocation backup.

Then add a bullet for the new artifact to the parent index at `Pillars/Knowledge Islands/Model/Tools/Claude/Live Artifacts/Live Artifacts.md`.
...
- Once three or four recipes are collected, skim the set together to factor any recurring cross-cutting patterns into [[Pillars/Knowledge Islands/Model/Agents/Agentic AI/AI Automation Patterns|AI Automation Patterns]] rather than repeating them in each recipe.
