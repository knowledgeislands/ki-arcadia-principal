...
The Claude agent specific activity prompt for the Health Check activity. This is maintained as an agentic AI specific task instruction that it can easily use at runtime rather than having to read and understand all of the note hierachy and inheritance at runtime.
...
## Step 1 - Load context
Read $REPOSITORY/CLAUDE.md and $REPOSITORY/Pillars/Knowledge Islands/Model/Tools/Claude/Mistakes and Lessons.md.

## Step 2 - CLAUDE.md vs Island Skill alignment
Read $REPOSITORY/Pillars/Knowledge Islands/Model/Agents/Claude/Island Skill.md.
...
Read the notes in $REPOSITORY/Pillars/Knowledge Islands/.
