...
What each tending activity does and why is documented at Layer 1 in [[Knowledge Islands/Activities/Tending/Tending|Activities/Tending]]. This folder holds only the executable prompts - one note per activity once migrated from the scheduled task definitions.
