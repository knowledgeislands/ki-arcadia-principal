...
For each task, locate the matching Prompt note under `Pillars/Knowledge Islands/Model/Tools/Claude/Activities/`. The task ID prefix is
documented in [[Knowledge Capital/Charter|Charter]].
