...
- `/Pillars/Knowledge Islands/Model/Activities/{activity-group-name}/{activity-name}`
- `/Pillars/Knowledge Islands/Model/Agents/{agent-name}/{activity-group-name}/{activity-name}`
...
Note to Reviewer: can we make this self referencing and effectively this is the `/Pillars/Knowledge Islands/Model/Activities/All/All/All.md` note?
...
- **Location:** `/Pillars/Knowledge Islands/Model/Agents/Agentic AI/` or ``/Pillars/Knowledge Islands/Model/Agents/{Agent}/`
