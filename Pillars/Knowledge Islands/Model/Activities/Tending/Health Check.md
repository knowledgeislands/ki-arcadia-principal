...
- **CLAUDE.md vs Island Skill alignment** - reads `CLAUDE.md` and `Pillars/Knowledge Islands/Model/Agents/Claude/Island Skill.md`, identifies any gaps or drift between the two, and proposes updates to the skill where needed
