...
The tools agents use are documented separately in [[Knowledge Islands/Governance/Tools/Tools]]. The distinction matters: `Agents/` covers operating behaviour; `Tools/` covers configuration and connection. A given AI system appears in both - once for how it acts, once for how it is set up.
