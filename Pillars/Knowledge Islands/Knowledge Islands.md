...
- [[Notes]] - the base format every note follows; the grammar of the island
  ...
  - [[Format]] - physical structure, headings, tables, wikilinks
  - [[Activity Note]] - the specialised format for activity notes
...
- [[Residency]] - three tiers of knowledge storage; what belongs where and how it moves
- [[Structure]] - the island's geography; physical stores, Library, Streams, routing rules
