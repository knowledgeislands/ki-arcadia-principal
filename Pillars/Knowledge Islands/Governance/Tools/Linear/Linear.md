...
When interacting with Linear's UI via Claude in Chrome, the following patterns apply (documented after operational issues - see [[Mistakes and Lessons]], 10 April 2026):
