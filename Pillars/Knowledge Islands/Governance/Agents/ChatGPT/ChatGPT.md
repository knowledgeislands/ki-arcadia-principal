...
If ChatGPT is given direct write access or used to run scheduled tasks in future, this note will expand into a full agent layer alongside [[Pillars/Knowledge Islands/Governance/Agents/Claude/Claude|Claude]].

For tool-level configuration and usage notes, see [[Pillars/Knowledge Islands/Governance/Tools/ChatGPT/ChatGPT|Tools → ChatGPT]].
