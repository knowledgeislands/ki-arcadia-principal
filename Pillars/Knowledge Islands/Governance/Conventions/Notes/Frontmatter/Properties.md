...
| `day_type`    | Calendar daily notes only - `work-day`, `bank-holiday`, `annual-leave`, or `weekend`. Set by Morning Briefing automation; see [[Pillars/Knowledge Capital/Activities/Schedule\|Schedule]]. |
