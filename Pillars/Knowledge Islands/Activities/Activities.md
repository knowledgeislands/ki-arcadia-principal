...
This index covers Layer 1 content: what each activity does and why. The prompts that drive them - Claude-specific and island-specific - live at Layer 5 in [[Claude/Activities/Activities|Tools/Claude/Activities]]. For the full five-layer model and prompt authoring conventions, see [[Authoring Activities]].
