...
- **CLAUDE.md vs Island Skill alignment** - reads `CLAUDE.md` and `Pillars/Knowledge Islands/Agents/Claude/Island Skill.md`, identifies any gaps or drift between the two, and proposes updates to the skill where needed
...
## Step 1 - Load context
Read $REPOSITORY/CLAUDE.md and $REPOSITORY/Pillars/Knowledge Islands/Tools/Claude/Mistakes and Lessons.md.

## Step 2 - CLAUDE.md vs Island Skill alignment
Read $REPOSITORY/Pillars/Knowledge Islands/Agents/Claude/Island Skill.md.
