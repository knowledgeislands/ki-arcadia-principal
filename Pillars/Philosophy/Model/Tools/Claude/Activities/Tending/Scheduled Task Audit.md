...
Run this bash command to find the Knowledge Capital folder and derive the repository root:
  ...
  PROMPTS_DIR="$REPOSITORY/Pillars/Philosophy/Model/Tools/Claude/Activities"
  echo "Repository: $REPOSITORY"

Then read:
1. $REPOSITORY/CLAUDE.md - KI operating instructions
2. $REPOSITORY/Pillars/Philosophy/Model/Tools/Claude/Mistakes and Lessons.md - pre-flight check
