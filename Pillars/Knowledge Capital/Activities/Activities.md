...
The authoritative record of which activities are enabled - the operational roster - lives in the [[Knowledge Capital/Charter|Charter]]. This folder is the timing model; the Charter is the activation record.
