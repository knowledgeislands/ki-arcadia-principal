...
This folder holds the island-specific timing configuration for Arcadia's automated activities. The generic activity patterns - what each automation does and why - are defined in [[Knowledge Islands/Activities/Activities]] under Knowledge Islands. What lives here is the timing model: the day-type taxonomy that automations read from daily note frontmatter to decide whether and how to run.
...
- [[Pillars/Knowledge Islands/Activities/Activities|Activities]] - generic activity definitions this island runs
