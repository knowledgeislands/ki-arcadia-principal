...
**Avoid:** disconnected floating UI panels, abstract technical voids, sterile grid-only environments.
...
Different forms of knowledge may be represented through terrain metaphors. This system should remain subtle rather than literal.
...
Space is meaningful. Core principles:
...
Animations and transitions should feel slow, intentional, fluid, tidal, orbital, infrastructural, and calm.

**References:** ocean currents, celestial mechanics, wind patterns, migration routes, flowing water.

**Avoid:** hyperactive animations, bouncing interactions, flashy transitions, chaotic particle effects, attention-seeking motion.
...
Typography should reinforce readability, trust, longevity, and intellectual clarity.

---

## Colour Palette

**Primary:** deep ocean blue, midnight navy, forest green, moss green, sandstone, warm parchment, soft teal, muted turquoise.

**Accents:** gold, amber, copper, soft sunlight tones.

**Backgrounds:** off-white, warm paper, mist grey, soft atmospheric gradients.

**Avoid:** pure black, harsh white, oversaturated neon colours, bright RGB palettes.

The overall palette should feel natural, enduring, navigable, calm, and atmospheric.
...
**Use:** soft lighting, subtle texture, atmospheric depth, calm oceans, layered terrain, elegant icons, restrained detail.

**Avoid:** photorealism, comic-book style, childish illustration, excessive realism, low-detail flat clipart.

---

## UI and System Design

Interfaces should feel modular, breathable, knowledge-centric, layered, map-inspired, and infrastructural rather than app-like.
...
Human and AI agents should coexist naturally, not compete visually, and feel collaborative within shared ecosystems.

**Human agents represent:** stewardship, interpretation, context, wisdom, judgement.

**AI agents represent:** augmentation, operational scale, synthesis, continuity, infrastructure support.

**Avoid:** humanoid robots, glowing evil AI eyes, sci-fi android aesthetics, AI dominance imagery.
...
**Avoid:** excessive detail, tiny text, photorealistic scenes, cluttered compositions, generic tech startup marks.
