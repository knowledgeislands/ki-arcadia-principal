...
- The emblem and wordmark should be treated as a lockup - do not separate them without explicit design intent
- Minimum size: sufficient for the arch motif to remain legible
- Monochrome version: drop to navy or forest green on light backgrounds; white on dark
- Clear space: maintain padding equivalent to the height of the "K" in the wordmark on all sides
- Do not stretch, recolour, or add effects to the mark
