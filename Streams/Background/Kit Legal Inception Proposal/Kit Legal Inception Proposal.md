...
`kit-legal` is a satellite island of the Kit archipelago. It needs adding to the Cowork project and then bootstrapping into the Knowledge
Islands model.
...
3. Create `Pillars/Knowledge Capital/` following the standard pattern (Identity, Physical Locations, Routing Rules, Glossary, Governance
   instance)
