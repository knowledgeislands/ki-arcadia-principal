...
| Maintenance prompts | 🔲 Not started | Migrate Health Check, Knowledge Rebuild, Scheduled Task Audit, KI Convergence Check prompts             |
...
| Arcadia skill       | 🔲 Not started | Define and configure the Arcadia KI skill                                                               |
...
| KI note is the draft; scheduled task is the release               | Maintains the prompt editing discipline from [[Pillars/Knowledge Islands/Governance/Activities/Authoring Activities | Authoring Activities]] |
...
| Prompt sync status between KI notes and Cowork scheduler is unknown | Scheduled Task Audit will surface any drift on its next run |
